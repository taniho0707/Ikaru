...
WallSensor::WallSensor() :
	...
	VAL_THR_LEFT(175-10),
	VAL_THR_FRONT(113),
	VAL_THR_RIGHT(205-10-30),
	VAL_THR_FRIGHT(185),
	VAL_THR_FRONT_SUB(200),

	// 斜めの制御をかける閾値
	VAL_THR_CONTROL_LEFT(250),
	VAL_THR_CONTROL_RIGHT(270),

	VAL_THR_GAP_FLEFT(160),
	VAL_THR_GAP_LEFT(175+10-10-5),
	VAL_THR_GAP_RIGHT(205+10-10-5-30),
	VAL_THR_GAP_FRIGHT(130),
	VAL_THR_GAP_DIAGO_FLEFT(160),
	VAL_THR_GAP_DIAGO_LEFT(180+50),
	VAL_THR_GAP_DIAGO_RIGHT(170+50),
	VAL_THR_GAP_DIAGO_FRIGHT(140),
	
	VAL_THR_SLALOM_FLEFT(500),
	VAL_THR_SLALOM_LEFT(500+50),
	VAL_THR_SLALOM_RIGHT(500+50),
